      ...
      <CardContent className="pt-6">
        ...
        <div className="text-center mt-6">
          <style dangerouslySetInnerHTML={{
            __html: `.pp-4SBJE4CC562B4{text-align:center;border:none;border-radius:0.25rem;min-width:11.625rem;padding:0 2rem;height:2.625rem;font-weight:bold;background-color:#FFD140;color:#000000;font-family:"Helvetica Neue",Arial,sans-serif;font-size:1rem;line-height:1.25rem;cursor:pointer;}`
          }} />
          <form action="https://www.paypal.com/ncp/payment/4SBJE4CC562B4" method="post" target="_blank" style={{display:'inline-grid',justifyItems:'center',alignContent:'start',gap:'0.5rem'}}>
            <input className="pp-4SBJE4CC562B4" type="submit" value="Donate if this was useful" />
